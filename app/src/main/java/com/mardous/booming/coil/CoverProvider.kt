...
class CoverProvider : ContentProvider() {
    ...
    override fun openFile(uri: Uri, mode: String): ParcelFileDescriptor? {
        ...
        // Return null immediately - Coil will handle async loading through fetchers
        // This prevents blocking the main thread in ContentProvider
        return null
    }
    ...
    companion object {
        ...
        private const val COVER_LOAD_TIMEOUT_MS = 5000L // 5 seconds timeout
